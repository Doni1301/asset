...
class M_detail_keluar extends CI_Model {
	...
	public function get_detail_keluar($no_keluar){
		$this->db->select('barang.kode_barang, detail_keluar.*');
		$this->db->from('detail_keluar');
		$this->db->join('barang', 'detail_keluar.nama_barang=barang.nama_barang');

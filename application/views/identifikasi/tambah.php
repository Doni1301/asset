				...
				<div class="row">
					<div class="col">
						<div class="card shadow">
							...
							<div class="card-body">
								<form action="<?= base_url('identifikasi/proses_tambah') ?>" id="form-tambah" method="POST">
									<h5>Personal Indentifikasi Perangkat IT</h5>
									<hr>
									<div class="form-row">
										<div class="form-group col-2">
											<label>No. Identifikasi</label>
											<input type="text" name="no_iden" value="IDN<?= time() ?>" readonly class="form-control">
										</div>
										<div class="form-group col-2">
											<label>Tanggal Identifikasi</label>
											<input type="text" name="tgl_iden" value="<?= date('d/m/Y') ?>" readonly class="form-control">
										</div>
										<div class="form-group col-2">
											<label>Jam</label>
											<input type="text" name="jam_iden" value="<?= date('H:i:s') ?>" readonly class="form-control">
										</div>
									</div>
									<br>
									<div class="row">

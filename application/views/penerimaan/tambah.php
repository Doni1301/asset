						...
						<div class="card shadow">
							...
							<div class="card-body">
								<form action="<?= base_url('penerimaan/proses_tambah') ?>" id="form-tambah" method="POST">
									...
									<hr>
									<div class="form-row">
										<input type="hidden" name="id_pengguna" value="<?= $this->session->login['id'] ?>">
										<div class="form-group col-2">
											<label>No. Terima</label>
											<input type="text" name="no_terima" value="GRN<?= time() ?>" readonly class="form-control">
										</div>
										...
										<div class="col-md-10">
											...
											<div class="form-row">
												<div class="form-group col-10">
													...
													<input type="text" name="keterangan" value="" class="form-control" autocomplete="off">
												</div>
											</div>
										</div>
									</div>
